...
const Signup = () => (
  <View style={[styles.container, styles.darkBackground]}>
    ...
    <ThemeButton onPress={() => console.log("Signed up!")} text="Sign up" style={{marginBottom: constants.grid.sm}} />
    <ThemeButton onPress={() => console.log("Signed up with FB!")} theme="facebook" text="Sign up with Facebook" style={{marginBottom: constants.grid.sm}}/>
  </View>
);
